...
public class InsertRoomsClientRequest extends ClientRequest<MaisonRoom, String> {

    public InsertRoomsClientRequest(
            NetworkConfig networkConfig, int myBirthDate, Request request, MaisonRoom info, byte[] bytes)
            throws IOException {
